...
if __name__ == "__main__":
    ...
    def load_case(number):
        ...
        if number == 1:
            ...
            peak_cooling = np.array([0.0, 0.0, 22.0, 44.0, 83.0, 117.0, 134.0, 150.0, 100.0, 23.0, 0.0, 0.0])
            ...
            peak_heating = np.array([160.0, 142, 102.0, 55.0, 0.0, 0.0, 0.0, 0.0, 40.4, 85.0, 119.0, 136.0])
            ...
            monthly_load_cooling = monthly_load_cooling_percentage * 150 * 10**3  # kWh
            peak_cooling = np.array([0.0, 0.0, 22.0, 44.0, 83.0, 117.0, 134.0, 150.0, 100.0, 23.0, 0.0, 0.0])
            peak_heating = np.array([300.0, 268.0, 191.0, 103.0, 75.0, 0.0, 0.0, 38.0, 76.0, 160.0, 224.0, 255.0])
    ...
    def check_cases():
        ...
        for i in (1, 2, 3, 4):
            ...
            print(
                f"correct answer L2: {correct_answers_L2[i-1]}; calculated answer L2: {round(borefield.H,2)}; error: "
            ...
            print(
                f"correct answer L3: {correct_answers_L3[i - 1]}; calculated answer L3: {round(borefield.H, 2)}; error: "
    ...
    def check_custom_datafile():
        ...
        borefield = Borefield(simulation_period=20, peak_heating=li, peak_cooling=li, baseload_heating=li, baseload_cooling=li)

        borefield.set_ground_parameters(data)

        customField = gt.boreholes.rectangle_field(N_1=12, N_2=10, B_1=6.5, B_2=6.5, H=110.0, D=4, r_b=0.075)
        ...
        for i in (1, 2, 3, 4):
            ...
            borefield.size(100)
            print(
                f"correct answer: {correct_answers[i-1]}; calculated "
