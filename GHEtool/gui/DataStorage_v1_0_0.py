...
class DataStorage:
    ...
    def __init__(self, ui: int) -> None:
        ...
        self.Depth_Method: int = getattr(obj, "comboBox_depth_Method").currentIndex() if (self.size_bore_field or self.determineDepth) else None
        ...
        if self.optimizeLoadProfile:
            ...
            self.dataFile = self.numberColumns = self.dataUnit = self.headerHeating = self.headerCooling = self.dataSeperator = self.dataDecimal = None
        ...
        self.peakHeating: list = [
            getattr(obj, "doubleSpinBox_Hp_Jan").value() * self.FactorPeak,
        ...
        self.peakCooling: list = [
            getattr(obj, "doubleSpinBox_Cp_Jan").value() * self.FactorPeak,
        ...
        self.monthlyLoadHeating: list = [
            getattr(obj, "doubleSpinBox_HL_Jan").value() * self.FactorDemand,
        ...
        self.monthlyLoadCooling: list = [
            getattr(obj, "doubleSpinBox_CL_Jan").value() * self.FactorDemand,
    ...
    def set_values(self) -> None:
        ...
        # method
        # sizing method for borehole depth sizing (0=fast, 1=robust)
        getattr(obj, "comboBox_depth_Method").setCurrentIndex(self.Depth_Method) if (self.size_bore_field or self.determineDepth) else None
